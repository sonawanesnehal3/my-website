import { GlobalFooter } from 'https://stagefooter--milo--sonawanesnehal3.hlx.page/libs/deps/global-footer/global-footer.js';

const consumerConfig = {
    imsClientId: 'milo', // Consumer can pass {consumerimsClientId}, it will take precedence over milo imsClientId
    miloLibs: 'https://stagefooter--milo--sonawanesnehal3.hlx.page/libs', //Consumer can pass {consumermiloLibs}, it will take precedence over miloLibs
