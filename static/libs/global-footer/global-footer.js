...
const menuModule = /* #__PURE__ */ Object.assign({"./menu/menu.js": () => Promise.resolve().then(() => menu$1)});
...
const decorateCrossCloudMenu = (content) => {
  ...
  crossCloudMenuEl.querySelectorAll('ul li').forEach((el, index) => {
    if (index === 0) el.querySelector('a')?.prepend(toFragment`${icons$1.home}`);
...
const menu = { decorateMenu, decorateLinkGroup };
